...
bkcore.hexgl.ShipControls = function (ctx) {
	...
	function onKeyUp(event) {
		switch (event.keyCode) {
			case 87: /*up*/	self.key.forward = false; break;

			case 83: /*down*/self.key.backward = false; break;

			case 65: /*left*/self.key.left = false; break;

			case 68: /*right*/self.key.right = false; break;
